...
/* package challenge-concurrency-0.1.0.0 */
#ifndef VERSION_challenge_concurrency
#define VERSION_challenge_concurrency "0.1.0.0"
#endif /* VERSION_challenge_concurrency */
#ifndef MIN_VERSION_challenge_concurrency
#define MIN_VERSION_challenge_concurrency(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_challenge_concurrency */
...
#define CURRENT_PACKAGE_KEY "challenge-concurrency-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "challenge-concurrency-0.1.0.0-inplace"
